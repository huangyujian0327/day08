			...
			<div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">部门名称 </span> <input type="text"
						name="name" class="form-control" id="txt_search_name">
				</div>
			</div>
				...
				$("#btn_add")
						.click(
								function() {
									...
									$("#form_user").resetForm();
									document.getElementById("hidden_txt_id").value = ''; //后台根据id判断是添加还是修改
									debugger;
				...
				$("#btn_edit").click(
						function() {
							var getSelections = $('#table_user')
									.bootstrapTable('getSelections');//获取列表选中的数据
