...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">人員名 </span>
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>人员性别：</td>
								<td>
								<input type="radio" id="tbEmpSex1" name="tbEmpSex" value="1"
							...
							<tr>
								...
								<td>人员生日：</td>
								<td>
								<input type="date" id="tbEmpBirthday" name="tbEmpBirthday"
	...
	var TableInit = function () {
	    ...
	    oTableInit.Init = function () {
	        $('#table_user').bootstrapTable({//底层对ajax封装，异步请求。
	            ...
	            sortName: "tbEmpId",
	            sortOrder: "desc",                   //排序方式
	            queryParams: oTableInit.queryParams,//传递参数（*） 查询参数(查询有关!!!!)
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            },
	            {
	                ...
	                title: '性别',
	                sortable:true,
	                formatter:function(value,row,index){//特殊处理
	                	return value=="1"?"男":"女";
	                }
	            },{
	                field: 'tbEmpAge',
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_add").click(function(){
	    		...
	    		$("#form_user").resetForm();
	    		document.getElementById("hidden_txt_tbEmpId").value=''; //后台根据id判断是添加还是修改
	    		debugger;
	    		$('#modal_user_edit').modal({backdrop: 'static', keyboard: false});//加遮罩层
				$('#modal_user_edit').modal('show');//弹出添加页面
	        });
	        
	    	$("#btn_edit").click(function(){
	    		var getSelections = $('#table_user').bootstrapTable('getSelections');//获取列表选中的数据
	    		debugger;
	    		if(getSelections && getSelections.length==1){
	    			initEditUser(getSelections[0]);//修改的数据回显
	    			$('#modal_user_edit').modal({backdrop: 'static', keyboard: false});//加遮罩层
					$('#modal_user_edit').modal('show');//弹出添加页面
	    		}else{
	...
	function initEditUser(getSelection){//dom操作 赋值
		...
		$('#tbEmpBirthday').val(new Date(getSelection.tbEmpBirthday)
		.Format('yyyy-MM-dd'));
